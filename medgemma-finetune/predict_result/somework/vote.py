...
SUMMARY_FILES = [
    ("/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/analysis_diff_com/medsiglip_summary_covid_best_thr.csv", "best_thr"),
    ("/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/analysis_diff_com/medsiglip_summary_covid_thr_0.5.csv", "thr_0.5"),
]

OUTPUT_ROOT = "/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/vote/medsiglip_vote"

# SUMMARY_FILES = [
#     ("/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/analysis_diff_com/trans_flat_summary_covid_best_thr.csv", "best_thr"),
#     ("/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/analysis_diff_com/trans_flat_summary_covid_thr_0.5.csv", "thr_0.5"),
# ]

# OUTPUT_ROOT = "/remote-home/share/25-jianfabai/medgemma-finetune/predict_result/somework/analysis_csv/cvpr/vote/trans_flat_vote"
...
def parse_summary_csv(summary_csv_path):
    """
    解析 summary_covid_best_thr.csv / summary_covid_thr_0.5.csv

    返回:
        included_folders: [folder1, folder2, ...]
        common_items: [ct_scan_x.npy, ...]
        non_common_by_folder: {folder: [ct_scan_x.npy, ...], ...}
    """
    included_folders = []
    common_items = []
