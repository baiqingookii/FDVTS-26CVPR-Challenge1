...
def main():
    ...
    # parser.add_argument("--model_dir", type=str, default="/remote-home/share/25-jianfabai/medgemma-finetune/save_model/3d_1_dataset_mean_lr5e-5_scale0.7-1/checkpoint-1728")  
    parser.add_argument("--model_dir", type=str, default="/remote-home/share/25-jianfabai/medgemma-finetune/save_model/3d_1_dataset_mean_lr5e-5_scale0.7-1_ori_and_1b/checkpoint-972")  # fine-tuned checkpoint dir
    ...
    print("[load] loaded keys:", len(state))
    ...
    # save_path = os.path.join(args.model_dir, "val_csv_predictions_huadongchuangkou.csv")
    save_path = os.path.join(args.model_dir, "val_csv_predictions_demo.csv")
