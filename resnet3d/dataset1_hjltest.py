...
class Lung3D_cvpr_patient_supcon(Data.Dataset):
    def __init__(self, train=False, val=False, inference=False, n_classes = 2, supcon=False, box_lung=False, seg_sth=None, img_depth=64, iccv_test=False, add_mosmed=False):
        ...
        if n_classes == 2:
            ...
            if inference:
                for scan in sorted(os.listdir(self.root_dir+'test/new/')):
                    img = os.path.join(self.root_dir+'test/new', scan)
                    name = scan
                    # print(scan)
            ...
            if train:
                ...
                for iter, rows in csv_file.iterrows():
                    ...
                    if box_lung:
                        ...
                        self.datalist.append((img, int(grade)-1, name, '/home/feng/hjl/eccv-submit/segment/eccv_seg/severity/lesionmask/train/'+name+'.npy'))
            ...
            if inference:
                ...
                for scan in sorted(os.listdir(self.root_dir+'test/severity/')):
                    ...
                    # print(scan)
                    if seg_sth == 'lesion':
                        self.datalist.append((img, name, name, '/home/feng/hjl/eccv-submit/segment/eccv_seg/severity/lesionmask/test/'+name+'.npy'))
                    elif seg_sth == 'lung':
                        self.datalist.append((img, name, name, '/home/feng/hjl/eccv-submit/segment/eccv_seg/severity/lungmask/test/'+name+'.npy'))
                    else:
                        self.datalist.append((img, name, name))
...
class Lung3D_eccv_patient_supcon(Data.Dataset):
    def __init__(self, train=False, val=False, inference=False, n_classes = 2, supcon=False, box_lung=False, seg_sth=None, img_depth=64, iccv_test=False, add_mosmed=False):
        ...
        # self.root_dir = "/remote-home/share/21-yuanruntian-21210240410/iccv25/challenge1/norm/"
        self.root_dir = '/remote-home/share/25-jianfabai/cvpr2026/challenge1/norm/'
        # self.root_dir = "/remote-home/share/21-yuanruntian-21210240410/cvpr24/challenge12/3d-norm/"
        # "/remote-home/share/21-yuanruntian-21210240410/cvpr24/challenge2/3d-norm/train/non-annotated/"
        ...
        if n_classes == 2:
            ...
            if val:
                # draw cam
                # i = 1
                # for scan in sorted(os.listdir(self.root_dir+'train/covid'+'/')):
                #     img = os.path.join(self.root_dir+'train/covid'+'/', scan)
                #     name = 'covid/'+scan
                #     if box_lung:
                #         self.datalist.append((img, i, name, self.val_dict[name.split('.')[0]]))
                #     else:
            ...
            if inference:
                ...
                for scan in sorted(os.listdir(self.root_dir+'test/')):
                    ...
                    self.datalist.append((img, name, name))  
                #修改
                # for scan in sorted(os.listdir(self.root_dir+'valid/')):
                #     img = os.path.join(self.root_dir+'valid', scan)
                #     name = scan
                #     # print(scan)s
                #     self.datalist.append((img, name, name))                 
