...
class Lung3D_eccv_patient_supcon(Data.Dataset):
    def __init__(self, train=False, val=False, na=False, inference=False, n_classes = 2, supcon=False, box_lung=False, seg_sth=None, iccv_test=False, add_mosmed=False):
        ...
        # self.root_dir = '/remote-home/share/25-jianfabai/cvpr2026/challenge1-iccv25/norm/'
        ...
        # 修改
        # self.root_dir = '/remote-home/share/25-jianfabai/cvpr2026/challenge1/3d/'
        ...
        if n_classes == 2:
            ...
            # types = ['non-covid','covid1']
            # types = ['non-covid1a','covid1a']
            # types = ['non-covid1b','covid1b']
            # types = ['non-covid1b1','covid1b1']
            types = ['non-covid_ori_and_1b','covid_ori_and_1b']
            ...
            if train:
                ...
                if iccv_test:
                    ...
                    for label in range(len(types)):
                        ...
                        path = '/remote-home/share/25-jianfabai/cvpr2026/pseudo/pseudo_labels_threshold_0.5_'+types[label]+'.csv'
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            if self.supcon:
                ...
                #修改
                # img_array = augment(img_array, ifhalfcrop=False, ifrandom_resized_crop=True, ifflip=False, ifrotate=True, ifcontrast=True,ifswap = False,filling_value=0)
        ...
        if self.val: 
            ...
            # img_array = augment(img_array, ifhalfcrop=False, ifrandom_resized_crop=True, ifflip=False, ifrotate=False, ifcontrast=True,ifswap = False,filling_value=0)
            #添加
            # img_array = rescale_gao(img_array)  # 强制 (64,256,256)
...
def augment(sample, ifhalfcrop=True, ifrandom_resized_crop=True, ifflip=False, ifrotate=True, ifcontrast=True,ifswap = False,filling_value=0):
    ...
    if ifrotate:
        ...
        sample = rotate(sample, angle, axes=(1,2), reshape=False, order=1, mode='constant', cval=filling_value)
